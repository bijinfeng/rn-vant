...
const ActivityIndicator = ({
  ...
  const size =
    typeof indicatorSize === 'string' ? (indicatorSize === 'small' ? 24 : 48) : indicatorSize || 24;
      ...
      <Animated.View style={{ width: size, height: size, opacity: fade }} collapsable={false}>
        {[0, 1].map(index => {
          ...
          const outputRange = Array.from(new Array(frames), (_, frameIndex) => {
            ...
            const _rotation = index ? +(360 - 15) : -(180 - 15);
            ...
            return `${direction * (180 - 30) * easing(progress) + _rotation}deg`;
          });
